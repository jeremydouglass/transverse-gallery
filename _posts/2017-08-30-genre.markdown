...
Afterwards, each researcher will immerse themselves within a specific genre, moving beyond merely encoding page turns toward developing a unique descriptive vocabulary to use in your encoding efforts -- in short, do develop not only your unique map of a genre, but mapping methods that are uniquely appropriate to that genre.
